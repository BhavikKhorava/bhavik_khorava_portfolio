  ...
  return (
    <section id="education" className="relative px-6 py-24 sm:px-10 sm:py-32">
      <div className="mx-auto w-full max-w-4xl">
        <Reveal>
          <SectionLabel index="05" title="education" command="cat education.log" />
        </Reveal>

        <RevealGroup className="grid gap-4 sm:grid-cols-2">
          {education.map((entry) => (
            <RevealItem key={entry.degree}>
              <div className="h-full rounded-lg border border-border bg-bg-panel/60 p-6 transition-colors hover:border-border-strong">
